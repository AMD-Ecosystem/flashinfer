 ...
 * whether bought by raising the floor (11-28% slower on gfx942, neutral on
 * gfx950) or at flat smem by halving NUM_STAGES_SMEM. The collapse is not this
 * constant. Numbers in git log; do not re-try blind.
 */
