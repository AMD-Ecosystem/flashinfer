...
_CONFIGS = [
    ...
    # head_dim=128 coverage (square + chunked + edge)
    (128, 128, 32, 8, 128, False),
    (128, 128, 32, 8, 128, True),
    (256, 2048, 16, 4, 128, False),
    (256, 2048, 16, 4, 128, True),
    (32, 256, 16, 4, 128, False),
    (32, 256, 16, 4, 128, True),
    # head_dim=64 coverage (square + chunked + edge)
    (128, 128, 32, 8, 64, False),
    (128, 128, 32, 8, 64, True),
    (256, 2048, 16, 4, 64, False),
    (256, 2048, 16, 4, 64, True),
    (32, 256, 16, 4, 64, False),
    (32, 256, 16, 4, 64, True),
]
