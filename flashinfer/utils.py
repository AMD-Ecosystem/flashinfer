...
from .rocm import torch_compile as _rocm_torch_compile
from .rocm.torch_compile import (
    use_torch_custom_ops_enabled as use_torch_custom_ops_enabled,
)
...
if TorchVersion(torch_version) < TorchVersion("2.4"):
    ...
    def register_custom_op(
        ...
        *,
        ...
        return _rocm_torch_compile.register_custom_op(
            name,
            fn,
    ...
    def register_fake_op(
        ...
        return _rocm_torch_compile.register_fake_op(name, fn)
