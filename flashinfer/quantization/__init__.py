...
# packbits is the only member of this package ROCm compiles. fp8_quantization
# and fp4_quantization reach for CUDA-only jit exports (sm121a_nvcc_flags,
# cutile) at import time, so gating them is what keeps `import flashinfer`
# working on HIP.
if IS_CUDA:
