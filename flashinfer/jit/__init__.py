...
if IS_CUDA:
    ...
    # mypy runs with follow_imports = "skip", so it cannot see through the star
    # import above. Names the IS_CUDA arm also binds stay visible via that arm;
    # these two are ROCm-only and have to be named here.
    from .attention import (  # noqa: F401
        gen_batch_decode_aiter_module as gen_batch_decode_aiter_module,
    )
    from .attention import get_batch_decode_aiter_uri as get_batch_decode_aiter_uri  # noqa: F401
else:
